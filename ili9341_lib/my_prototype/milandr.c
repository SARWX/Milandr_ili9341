...
int main()
{
	...
	ili9341_init();         // Инициализируем ili9341
	ili9341_clear(BLACK);   // Заполняем все одним цветом
	_delay_ms(1000);
	ili9341_setRotation(3); // Установим ориентацию экрана
	_delay_ms(2);
	display_init();         // Отобразить данные
